...
| 12 | Secure Transport (TLS & Noise) | **Hybrid** ✅ *built* | 🎭 **"The Impostor's Certificate."** Cert-validation-bypass MITM against a client that skips hostname checks; PKI trust-model comparison stays conceptual. *Why it's exciting: your forged certificate sails through — until one line of validation code slams the door in your face.* | `Week11 Questions.docx` (6 Q) |
